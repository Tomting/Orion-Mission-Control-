  ...
  if (typeof userCSSList != 'undefined') {
    ...
    for (var i = 0; i <= userCSSList.length; ++i) {
      if (i < userCSSList.length) {
        ...
        href.nodeValue                   = '/js/console/console/usercss-' + i + '.css';
  ...
  if (!this.getChildById(this.container, 'reconnect')   ||
    ...
    this.container.innerHTML   =
                       ...
                       '<div id="scrollable">' +
                         '<table id="kbd_button">' +
                           '<tr><td width="100%">&nbsp;</td>' +
                           '<td><img id="kbd_img" src="/js/console/console/keyboard.png" /></td>' +
                           '<td>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>' +
                         '</table>' +
                       ...
                       '<div class="hidden">' +
                         ...
                         '<iframe id="layout" src="/js/console/console/keyboard.html" />' + 
                        '</div>';
  }
    ...
    '<table class="popup" ' +
      ...
      '<tr><td>' +
        '<ul id="menuentries">' +
          ...
          '<hr />' +
          '<li id="beginconfig">' +
             (this.utfEnabled ? '<img src="/js/console/console/enabled.gif" />' : '') +
             'Unicode</li>' +
          '<li>' +
             (this.visualBell ? '<img src="/js/console/console/enabled.gif" />' : '') +
             'Visual Bell</li>'+
          '<li>' +
             (this.softKeyboard ? '<img src="/js/console/console/enabled.gif" />' : '') +
             'Onscreen Keyboard</li>' +
          '<li id="endconfig">' +
             (this.blinkingCursor ? '<img src="/js/console/console/enabled.gif" />' : '') +
             'Blinking Cursor</li>'+
...
VT100.prototype.beep = function() {
  if (this.visualBell) {
    ...
    try {
      ...
      try {
        this.beeper.src = '/js/console/console/beep.wav';
      } catch (e) {
      }
    }
  }
    ...
    if (!this.printWin || this.printWin.closed) {
      ...
      this.printWin.document.body.innerHTML =
        '<link rel="stylesheet" href="' +
          ...
          '/js/console/console/print-styles.css" type="text/css">\n' +
